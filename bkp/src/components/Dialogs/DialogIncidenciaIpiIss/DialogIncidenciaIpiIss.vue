<template>
    <v-dialog
        v-model="abrirModal"
        max-width="500px"
        content-class="dialog-atencao dialog-incidencia"
        persistent
    >
            ...
            <v-card-text class="pb-0">
                <v-layout row wrap>
                    <v-flex class="text-md-center">
                        <v-flex class="mb-2">Incidência de IPI e ISS para as seguintes atividades:</v-flex>
                        ...
                        <v-layout row wrap class="item" v-for="cnae in cnaes" :key="cnae.idcnae">
                            ...
                            <v-flex class="switch-area">
                                ...
                                >Não</label>
                                <v-switch v-model="cnae.blIncidencia" color="primary" label="Sim"></v-switch>
                            </v-flex>
                        </v-layout>
                    </v-flex>
                </v-layout>
...
<script src="./DialogIncidenciaIpiIss.js"></script>
<style lang="scss">
@import "./DialogIncidenciaIpiIss.scss";
</style>